...
// --- GET ALL MAHASISWA (Search, Filter, Pagination, JOIN Prodi) ---
...
// --- UPDATE MAHASISWA (Dengan Edit Foto) ---
export const updateMahasiswa = async (req: Request, res: Response) => {
  try {
    ...
    if ((req as any).file) {
        fields.push("foto = ?");
        values.push((req as any).file.filename);
        }
